...
在TensorFlow训练场景开启数据预处理下沉（即enable\_data\_pre\_proc开关配置为True）时可生成dp\_\*.csv文件。详情请参见《TensorFlow 1.15模型迁移指南》中的“[训练迭代循环下沉](https://gitcode.com/cann/tensorflow/blob/9.1.0/docs/zh/tfadapter_1/migration/performance_tuning/iteration_offload.md)”章节。
