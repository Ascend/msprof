...
- 参考文档：[昇腾环境变量参考](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910/maintenref/envvar/envref_07_0001.html)。
...
- **Q：安装 `mindstudio-profiler_26.1.0_aarch64.run --install` 时提示 `Not enough space left in /root` 怎么处理？**
