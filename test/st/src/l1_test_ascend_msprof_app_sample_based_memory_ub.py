...
class TestAscendMsprofAppSampleBasedMemoryUB(BaseAscendMsprofChecker):
    ...
    AI_VECTOR_CORE_UTILIZATION_SPEC = {
        ...
        "headers": ["ub_read_bw_vector(GB/s)", "ub_write_bw_vector(GB/s)", "ub_read_bw_scalar(GB/s)", "ub_write_bw_scalar(GB/s)"],
        "non_negative_columns": ["ub_read_bw_vector(GB/s)", "ub_write_bw_vector(GB/s)", "ub_read_bw_scalar(GB/s)", "ub_write_bw_scalar(GB/s)"],
    }
...
def test_ascend_msprof_app_sample_based_memory_ub(prof_path):
    TestAscendMsprofAppSampleBasedMemoryUB(prof_path).check_msprof_file()
