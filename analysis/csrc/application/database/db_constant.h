...
const std::string PROCESSOR_NAME_HOST_PLATFORM = "HOST_PLATFORM";
const std::string TABLE_NAME_NUMA_LEVELS_HIERARCHY_NAMES = "NUMA_LEVELS_HIERARCHY_NAMES";
const std::string TABLE_NAME_NUMA_METRICS = "NUMA_METRICS";
const std::string TABLE_NAME_NUMA_SCALING_VALUES = "NUMA_SCALING_VALUES";
const std::string TABLE_NAME_NUMA_TITLES_NAMES = "NUMA_TITLES_NAMES";
const std::string TABLE_NAME_HOST_CORE_THREAD = "HOST_CORE_THREAD";
const std::string TABLE_NAME_HOST_CORE_PROCESS = "HOST_CORE_PROCESS";
const std::string TABLE_NAME_HOST_CORE_METRIC_DESC = "HOST_CORE_METRIC_DESC";
const std::string TABLE_NAME_HOST_CORE_METRIC = "HOST_CORE_METRIC";
...
const std::string PROCESSOR_NAME_TASK_ASSOCIATION = "TASK_ASSOCIATION";
const std::string PROCESSOR_NAME_OP_STATISTIC = "OP_STATISTIC";
const std::string TASK_TYPE_WRITE_BACK = "WRITE_BACK";
const std::string TASK_TYPE_INVALID = "INVALID";
const std::string TASK_TYPE_HCCL_AI_CPU = "HCCL_AI_CPU";
const std::string TASK_TYPE_COMMUNICATION = "COMMUNICATION";
...
const std::string TABLE_NAME_ENUM_OVERLAP_ANALYSIS_TYPE = "ENUM_OVERLAP_ANALYSIS_TYPE";
...
// npu module name，取值与 runtime 的 pkg_inc/driver/hal_pkg/common_pkg.h 对齐；
// 59 PYPTO 为该头文件暂未补充的 module id，先在此登记。
const std::unordered_map<std::string, uint16_t> MODULE_NAME_TABLE = {{"UNKNOWN", 0},
                                                                     {"IDEDD", 1},
                                                                     {"IDEDH", 2},
                                                                     {"HCCL", 3},
                                                                     {"FMK", 4},
...
// overlap analysis 类型
const std::unordered_map<std::string, uint16_t> OVERLAP_TYPE_TABLE{
    {"COMPUTE", 0}, {"COMMUNICATION", 1}, {"COMM_NOT_OVERLAP_COMP", 2}, {"FREE", 3}, {"RESERVE", UINT16_MAX}};

const std::unordered_map<std::string, std::unordered_map<std::string, uint16_t>>

    ENUM_TABLE = {{TABLE_NAME_ENUM_API_TYPE, API_LEVEL_TABLE},
                  ...
                  {TABLE_NAME_ENUM_OVERLAP_ANALYSIS_TYPE, OVERLAP_TYPE_TABLE}};
...
const std::unordered_map<std::string, std::string> META_DATA = {{NAME_STR(SCHEMA_VERSION), SCHEMA_VERSION},
...
const std::unordered_map<uint16_t, std::string> CHIP_TABLE = {
    {0, "Ascend310"}, {1, "Ascend910A"}, {4, "Ascend310P"}, {5, "Ascend910B"}, {7, "Ascend310B"}, {15, "Ascend950"},
};
}  // namespace Application
}  // namespace Analysis
