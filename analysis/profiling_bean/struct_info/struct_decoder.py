...
class StructDecoder:
    ...
    STRUCT_FMT_DICT = {
        ...
        "CaptureStreamInfoV2Bean": StructFmt.CAPTURE_STREAM_INFO_V2_FMT,
        ...
        "TaskTrackV2Bean": StructFmt.TASK_TRACK_V2_FMT,
        "TaskTrackChip6Bean": StructFmt.TASK_TRACK_FMT,
        "TaskTrackV2Chip6Bean": StructFmt.TASK_TRACK_V2_FMT,
