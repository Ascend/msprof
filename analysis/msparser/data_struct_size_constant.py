...
class StructFmt:
    ...
    # compact runtime V2
    TASK_TRACK_V2_RESIDUAL_SIZE = 16
    TASK_TRACK_V2_FMT = "HHIIIQHHIHHIQ" + "B" * TASK_TRACK_V2_RESIDUAL_SIZE
    TASK_TRACK_V2_DATA_SIZE = struct.calcsize(TASK_TRACK_V2_FMT)
    ...
    # capture (V1): captureStatus/modelStreamId/originalStreamId/modelId/deviceId
    CAPTURE_STREAM_INFO_RESIDUAL_SIZE = 30
    CAPTURE_STREAM_INFO_FMT = "HHIIIQHHHHH" + "B" * CAPTURE_STREAM_INFO_RESIDUAL_SIZE
    CAPTURE_STREAM_INFO_SIZE = struct.calcsize(BYTE_ORDER_CHAR + CAPTURE_STREAM_INFO_FMT)

    # capture V2
    CAPTURE_STREAM_INFO_V2_RESIDUAL_SIZE = 24
    CAPTURE_STREAM_INFO_V2_FMT = "HHIIIQHBBIII" + "B" * CAPTURE_STREAM_INFO_V2_RESIDUAL_SIZE
    CAPTURE_STREAM_INFO_V2_SIZE = struct.calcsize(CAPTURE_STREAM_INFO_V2_FMT)
