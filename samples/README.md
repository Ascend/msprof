...
本目录包含mstx各种接口的使用用例，各个文件夹对应不同用例，供用户理解使用mstx接口。目录以及用例具体说明如下：

| 样例                                   | 说明                                                | 支持产品型号                                                  |
| -------------------------------------- | -------------------------------------------------- | ------------------------------------------------------------ |
| [mstx_with_domain](./mstx_with_domain) | 展示mstx接口在默认domain与自定义domain中打点的使用方式 | Atlas A3 系列产品<br/>Atlas A2 系列产品/Atlas 800I A2 推理产品/A200I A2 Box 异构组件<br/>Atlas 200I/500 A2 推理产品<br/>Atlas 推理系列产品<br/>Atlas 训练系列产品 |
